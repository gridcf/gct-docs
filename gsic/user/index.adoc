...
will need to authenticate yourself to GCT services.
...
+
It is important to keep in mind when your cert will expire - after your user certificate expires, you may not be able to use secure services in GCT!
