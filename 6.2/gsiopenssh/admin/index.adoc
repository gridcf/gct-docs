...
:doctype: book
= GCT 6.2 GSI-OpenSSH: System Administrator's Guide =
...
link:../../admin/install/index.html[Installing GCT 6.2]. Read through this guide
before continuing!
--
...
--
GSI-OpenSSH is built and installed as part of a default GCT 6.2
...
for your GCT 6.2 installation. For example:
...
Grid Community Toolkit, follow the instructions in
link:../../admin/install/index.html[Installing GCT 6.2] with the following
changes.
