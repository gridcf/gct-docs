...
= GCT 6.2 MyProxy: System Administrator's Guide =
:doctype: book
...
installation.
[IMPORTANT]
This information is in addition to the basic Grid Community Toolkit prerequisite, overview, installation, security configuration instructions in link:../../admin/install/index.html[Installing GCT 6.2]. Read through this guide before continuing!
...
--
MyProxy is built and installed as part of a default GCT 6.2 installation.
