...
:doctype: book
= GCT 6.2 XIO: System Administrator's Guide =
...
link:../../admin/install/index.html#gtadmin-install[GCT 6.2 installation
instructions].
[IMPORTANT]
--
This information is in addition to the basic Grid Community Toolkit prerequisite, overview, installation, security configuration instructions in the link:../../admin/install/index.html[Installing GCT 6.2]. Read through this guide before continuing!
--
...
--
XIO is built and installed with a default GCT 6.2 installation, see the
link:../../admin/install/index.html#gtadmin-install[Installing GCT 6.2].
