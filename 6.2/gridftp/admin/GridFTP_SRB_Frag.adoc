...
* **Grid Community Toolkit** - You need the GridFTP distributed with GCT or GT (compatible with GT 4.0.1 or later and GCT 6.2 or later). You can find that http://www.globus.org/toolkit/downloads/{version}/[here].
