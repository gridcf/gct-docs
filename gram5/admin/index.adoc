...
:doctype: book
= GCT 6.2 GRAM5: System Administrator's Guide =
...
link:../../admin/install/index.html#gtadmin-install[Installing GCT 6.2] and
install the
...
GRAM5 in GCT 6.2 supports the following LRM adapters: Condor, PBS,
...
described in link:../../admin/install/index.html[Installing GCT 6.2].
