...
:doctype: article
= GCT 6.2 Migrating Guide for XIO =
...
For GCT 6.2 no other differences will be noticed by those previously familiar
with globus_xio. 
...
Users of GCT 6.2 who are previously familiar with globus_xio will notice
no difference. 
