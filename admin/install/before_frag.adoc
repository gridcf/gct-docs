...
Before you start installing the Grid Community Toolkit 6.0, there are a few
things you should consider. The toolkit contains several components, and
you may only be interested in some of them. 

The Grid Community Toolkit version 6.0 includes:
...
the simplest platforms on which to install GCT services. 

For the purposes of this documentation, GCT is being installed on a
machine called **++elephant++**. 

include::../quickstart/typography_frag.adoc[]
