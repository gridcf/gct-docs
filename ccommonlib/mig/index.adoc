...
:doctype: article
= GCT 6.2 Migrating Guide for C Common Libraries =
...
[[ccommonlib-migrating-GT6.0]]
== Migrating C Common Libraries from GT6.0 ==

GCT6.2 is API (source) and ABI (binary) compatible with GT6.0.

 
[[ccommonlib-migrating-GT5.2]]
== Migrating C Common Libraries from GT5.2 ==

GCT6.2 is API (source) and ABI (binary) compatible with GT5.2. Dependency
resolution for GCT6.2 is done with pkg-config only, not pkg-config or GPT.
