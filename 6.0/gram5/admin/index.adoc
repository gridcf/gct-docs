...
:doctype: book
= GCT 6.0 GRAM5: System Administrator's Guide =
...
link:../../admin/install/index.html#gtadmin-install[Installing GCT 6.0] and
install the
...
GRAM5 in GCT 6.0 supports the following LRM adapters: Condor, PBS,
...
There are several LRM adapters included in the GCT 6.0. For some, there
...
described in link:../../admin/install/index.html[Installing GCT 6.0]. 

LRM adapter packages included in the GCT 6.0 release are: 
...
--
There are several tools provided with GCT 6.0 to manage GRAM5, as well as
...
include::../GRAM5_Audit_Logging_Frag.adoc[]
...
include::../GRAM5_Troubleshooting_Admin_Frag.adoc[]
