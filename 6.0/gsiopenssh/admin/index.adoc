...
:doctype: book
= GCT 6.0 GSI-OpenSSH: System Administrator's Guide =
...
--
GSI-OpenSSH is built and installed as part of a default GCT 6.0
...
for your GCT 6.0 installation. For example:
