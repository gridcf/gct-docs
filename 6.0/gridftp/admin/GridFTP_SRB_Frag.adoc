...
* **Grid Community Toolkit** - You need the GridFTP distributed with GT or GCT (compatible with 4.0.1 or later). You can find that http://toolkit.globus.org/toolkit/downloads/6.0/[here].
