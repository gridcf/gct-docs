...
http://toolkit.globus.org/api/c-globus-6.0/group%5f%5fglobus%5f%5fftp%5f%5fclient%5f%5fapi.html[FTP
...
line options], the link:../../gridftp/key/index.html[GCT 6.0 GridFTP Key
